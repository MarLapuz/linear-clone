    ...
    <div className="text-white">
      <div className="text-center">
        <h2 className="mb-4 text-4xl md:mb-7 md:text-7xl">
          Unlike any tool <br className="hidden md:inline-block" /> you've used before
        </h2>
      ...
      <div className="flex snap-x  snap-mandatory gap-6 overflow-x-auto lg:flex-wrap">
        <div className="flex min-h-[48rem] w-full shrink-0 snap-center flex-col items-center  justify-end rounded-[4.8rem] border border-transparent-white bg-glass-gradient p-8 text-center md:p-14 lg:basis-[calc(66.66%-12px)]">
