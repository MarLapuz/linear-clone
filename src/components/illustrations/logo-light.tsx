export const LogoLightIllustration = () => (
  <svg viewBox="0 0 557 557" width="557" height="557" fill="none" className="m-auto max-h-full max-w-full">
    ...
    <defs>
      ...
      >
        ...
        <feGaussianBlur result="effect1_foregroundBlur_1706_102555" stdDeviation="50"></feGaussianBlur>
      </filter>
    </defs>
  </svg>
);
